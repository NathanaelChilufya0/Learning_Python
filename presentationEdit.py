...
class TodoList:
    def __init__(self, root):
        ...
        self.move_up_button = tk.Button(self.root, text="Move Up", command=lambda: self.move_task(self.task_list.curselection()[0] - 1), bg="lightblue", fg="black", font=("Arial", 12))
        self.move_up_button.grid(row=3, column=1, padx=5, pady=5)

        self.move_down_button = tk.Button(self.root, text="Move Down", command=lambda: self.move_task(self.task_list.curselection()[0] + 1), bg="lightgreen", fg="black", font=("Arial", 12))
        self.move_down_button.grid(row=4, column=1, padx=5, pady=5)
